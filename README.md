...
`@monkin/di` is a lightweight (445 bytes), type-safe dependency injection container for TypeScript. It leverages TypeScript's advanced type system to provide a fluent API for service registration and resolution with full type safety and autocompletion.
...
- **Zero Runtime Dependencies**: Extremely lightweight (445 bytes minified / 308 bytes gzipped).
